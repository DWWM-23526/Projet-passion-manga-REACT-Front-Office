...
const MangakaScreen = () => {
  ...
  const mangaList = mangakas.map((mangaka) => (
    <Col xs={12} sm={6} md={4} lg={3} xl={3} className="d-flex justify-content-evenly" key={mangaka.id}>
      <Cards title={mangaka.title} imageUrl={mangaka.imgSrc} url={`/mangaka/${mangaka.id}`} />
    </Col>
  ));
